...
The sources for this package are in the main [Genkit](https://github.com/nadeem7sg/genkit) repo. Please file issues and pull requests against that repo.

## Links

-  **Documentation:** [https://genkit.dev/docs/plugins/google-genai/](https://genkit.dev/docs/plugins/google-genai)
-   **Source Code:** [https://github.com/nadeem7sg/genkit/tree/main/js/plugins/google-genai](https://github.com/nadeem7sg/genkit/tree/main/js/plugins/google-genai)
